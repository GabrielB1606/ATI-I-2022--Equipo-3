...
class testSignUp( unittest.TestCase ):
    ...
    # test a correct sign up process
    ...
    def test_register_not_email(self):
        # go to the sign up page
        self.driver.get("http://localhost:5000/sign_in")
        ...
        # if I'm still in login, i haven't logged in (duh...)
        self.assertTrue( self.driver.current_url.split("/")[-1] == "sign_in" , "Pudimos registrarnos sin especificar un correo" )

    def test_register_not_confirm(self):
        # go to the sign up page
        self.driver.get("http://localhost:5000/sign_in")
        ...
        # if I'm still in login, i haven't logged in (duh...)
        self.assertTrue( self.driver.current_url.split("/")[-1] == "sign_in" , "Pudimos registrarnos sin confirmar la contraseña" )
